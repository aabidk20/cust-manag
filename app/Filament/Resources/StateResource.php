    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                // ->hidden(!auth()->user()->email==='admin@example.com'), //not hidden(visible) if the user is admin
                Tables\Columns\TextColumn::make('name')
                    ->label('State Name')
                    ->sortable()
                    // ->searchable(isIndividual: true) //search by this column only
                    ->searchable(),
                ...
                Tables\Columns\TextColumn::make('updated_at')
                    ...
                    ->sortable()
                    ->toggleable(isToggledHiddenByDefault: true),
            ])->defaultSort('country.name') //default sorting ascendant
            ->filters([
                //
            ])
            ->actions([
